...
#include "../../../applications/ekf-app/ekf-app.h"
#include "../../../applications/pid-app/pid-app.h"
...
void app_main(void)
{
	...
	switch(hf_cpuid()){
		...
		case 1: // << EKF
			hf_spawn(ekf_main, 100, 99, 99, "ekf_main-ps-task", 6* 4096);
			break;

		case 2: // << PID
			hf_spawn(pid_main, 100, 99, 99, "pid_main-ps-task",6* 4096);
			break;
